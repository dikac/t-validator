...
export default class Type<Subject, Value, Result extends Validatable & MessageInterface & Immutable<Value> = Validatable & MessageInterface & Immutable<Value>> implements Validator<Subject, Result> {
    private result;
